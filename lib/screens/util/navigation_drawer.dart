...
import 'navigation_drawer.viewmodel.dart';
...
//            ListTile(
//              leading: Icon(Icons.gamepad),
//              title: Text('R: ${vm.currentGameTitle}'),
//              onTap: () {
//                vm.onPageClicked(PageType.gameWithRuns);
//                Navigator.pop(context);
//              },
//            ),
            Divider(),
...
//              onTap: () {
//                vm.onPageClicked(PageType.dev2);
//                Navigator.pop(context);
//              },
//            ),
          ];
...
//          ListTile(
//            leading: Icon(Icons.error),
//            title: Text('participate game ids'),
//            onTap: () {
//              vm.onPageClicked(PageType.dev2);
//              Navigator.pop(context);
//            },
