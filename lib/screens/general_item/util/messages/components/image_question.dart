        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: buildGrid((index, length) =>
                  buildClickArea(getScale(index, length), index, context, themeModel))),
          ...
          Visibility(
            ...
            child: Padding(
              ...
              child: NextButton(
                  buttonText: item.description != "" ? item.description : AppLocalizations.of(context).translate('screen.proceed'),
...
//                <Widget>[widgetBuilder(colIndex*scale+0),,],
  ...
  Widget buildClickArea(
      double scale, int index, BuildContext context, GameThemesViewModel themeModel) {
    return new Expanded(
        child: AspectRatio(
      aspectRatio: scale,
      child: Padding(
...
//                  });
              ...
              child: Stack(
                children: [
                  ...
                  Visibility(
                    visible: selected[answers[index].id],
                    child: Positioned(
                      top: 5,
                      right: 5,
                      child: Icon(
  ...
  CachedNetworkImageProvider buildSelectImage(BuildContext context, String answerId) {
    if (item.fileReferences != null && item.fileReferences[answerId] != null)
      return new CachedNetworkImageProvider(
          "https://storage.googleapis.com/${AppConfig().projectID}.appspot.com${item.fileReferences[answerId].replaceFirst('//', '/')}",
          errorListener: () {
//            setState(() {
...
//            });
    ...
    return new CachedNetworkImageProvider(
      "https://storage.googleapis.com/${AppConfig().projectID}.appspot.com/game/${item.gameId}/generalItems/${item.itemId}/${answerId}.png",
    );
  }
}
