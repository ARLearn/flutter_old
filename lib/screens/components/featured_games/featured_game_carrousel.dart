                                ...
                                child: Container(
                                    decoration: new BoxDecoration(
                                        image: new DecorationImage(
                                            fit: BoxFit.cover,
                                            image:
                                                buildImage(context, 'featuredGames/backgrounds/${featuredGamesModel.games[i].gameId}.png'))),
                                    child: Column(
...
//  Container(
//  decoration: new BoxDecoration(
//  image: new DecorationImage(fit: BoxFit.cover, image: buildImage(context, deviceModel.games[i].title))) ,
//  child: Text("",
//
//  style: TextStyle(
//  color: Colors.white
...
//    path = 'featuredGames/Background.png';
