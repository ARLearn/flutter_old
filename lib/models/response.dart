...
class Response {
  ...
  Response({this.run, this.item, this.userId, this.lat, this.lng, this.value});
...
class PictureResponse extends Response {
  ...
  PictureResponse({this.path, Run run, GeneralItem item, String userId, double lat, double lng})
